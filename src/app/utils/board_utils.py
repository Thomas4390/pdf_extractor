...
def start_background_aggregation_load() -> bool:
    ...
    """
    global _background_agg_loading
...
def get_background_aggregation_status() -> dict:
    ...
    Returns:
        Dict with keys: loading, error, data, progress
    """
    return {
...
def apply_background_aggregation_data() -> bool:
    ...
    Call this when entering aggregation mode to use the pre-loaded data.

    Returns:
        True if data was applied, False if no data available
    """
    global _background_agg_data, _background_agg_error
...
def reset_background_aggregation_data() -> None:
    """Reset the background aggregation data (e.g., when sources change)."""
    global _background_agg_data, _background_agg_loading, _background_agg_error, _background_agg_progress
