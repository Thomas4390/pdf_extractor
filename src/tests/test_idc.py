...
Usage:
    python -m src.tests.test_idc [pdf_path] [options]
...
Examples:
    python -m src.tests.test_idc                          # Default PDF and mode
    python -m src.tests.test_idc --mode hybrid            # Test hybrid mode
    python -m src.tests.test_idc --mode vision --force    # Force vision extraction
    python -m src.tests.test_idc path/to/file.pdf --mode pdf_native
"""
...
async def test_extraction(
    ...
    original_config = get_model_config("IDC")
    ...
    if mode or model:
        ...
        register_model("IDC", temp_config)
    ...
    try:
        ...
        if mode or model:
            register_model("IDC", original_config)
